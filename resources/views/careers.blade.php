...
input[type=number] {
  -moz-appearance: textfield;
    ...
    <div class="container " >
        ...
        <h1 class="display-3" style="margin-top: 100px;" >Careers</h1>
        <div class="container ">
            <div class="row">
                <div class="col-md-12 col-lg-6 col-sm-12 ">

                    <img src="/assets/img/working.svg" alt="working" height="400px" width="400px">
                    <p class="lead ">Please upload your CV/Resume here.<br>Our team will try to reach you at your phone number or whatsapp.</p>

                    <p class="lead fw-bold">Note: only pdf and doc files supported.</p>
                </div>
                <div class="col-md-12 col-lg-6 col-sm-12">
                    <div class="get-in-touch">
                        <h1 class="display-5">Join now </h1>
                        <form action="careers" class="contact-form" id="contactus" method="post"  enctype="multipart/form-data" >
                          @csrf
                           ...
                           <div class="form-field col x-50">
                              <input id="number" class="input-text js-input" name="number" type="number" required>
                              <label class="label" for="number">Whatsapp Number</label>
                           </div><br>
                           <div class="form-field col x-100">
                            <div>
                                <label for="formFile" class="form-label">CV/Resume</label>
                                <input type="file" class="form-control"   id="formFile" name="file" accept="application/pdf,application/msword,
      ...
      {{-- Footer starts here --}}
  <footer id="footer" class="footer-1 " style="margin-top: 100px;">
