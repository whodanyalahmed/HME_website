...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">{{$var}}</a>
        <!-- Sidebar Toggle-->
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            Course id: <strong>{{$course->course_id}}</strong> 
                                        </div>
              
                                    </div>
                                </div>  
                                <div class="card-body">
                                  <h5 class="card-title"><a href="class/{{$course->course_id}}" class="text-dark">{{$course->name}}</a></h5>
